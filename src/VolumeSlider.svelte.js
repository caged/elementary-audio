...
/* src/VolumeSlider.svelte generated by Svelte v3.44.1 */
import {
	SvelteComponent,
	add_flush_callback,
	append,
...
function create_fragment(ctx) {
	...
	let slider_props = {
		...
		step: "0.01",
		valueVisible: false,
		disabled: !/*$powered*/ ctx[0]
	};

	if (/*$gain*/ ctx[1] !== void 0) {
		slider_props.value = /*$gain*/ ctx[1];
	}
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$powered*/ 1) slider_changes.disabled = !/*$powered*/ ctx[0];

			if (!updating_value && dirty & /*$gain*/ 2) {
				updating_value = true;
				slider_changes.value = /*$gain*/ ctx[1];
